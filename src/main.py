...
def initialize_game():
  ...
  snake.components[TailComponent].segments = [
...
def start_screen():
  ...
  while waiting_for_start:
    ...
    start_text = game_font.render("Press Enter to Start", True,
                                  (255, 255, 255))
    screen.blit(
        start_text,
...
while game_active:
  ...
  while running:
    ...
    if (snake_pos.x < 0 or snake_pos.x >= SCREEN_WIDTH or snake_pos.y < 0
